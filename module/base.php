...
class Amimoto_Dash_Base {
	...
	public function get_amimoto_plugin_file_list() {
		...
		if ( ! $this->is_amimoto_managed() ) {
			$amimoto_plugins['C3 Cloudfront Cache Controller'] = 'c3-cloudfront-clear-cache/c3-cloudfront-clear-cache.php';
			$amimoto_plugins['Nginx Cache Controller on GitHub'] = 'nginx-cache-controller/nginx-champuru.php';
			$amimoto_plugins['Nginx Cache Controller on WP.org'] = 'nginx-champuru/nginx-champuru.php';
		}
