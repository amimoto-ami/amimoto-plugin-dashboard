...
class Plugins {
    ...
    public static function get_plugin_file_path_by_name( string $plugin_name ) {
        ...
        if ( ! $plugin_slug || ! isset( $plugin_slug ) ) return null;
    ...
    public function list_amimoto_activated_plugins() {
		...
		$plugins = array();
        if ( ! isset( $active_plugins ) || ! is_array( $active_plugins ) ) return $plugins;
    ...
    public static function activate( string $plugin_name ) {
		...
		activate_plugin( $plugin_file_path, '', Constands::is_multisite() );
    }
    ...
    public static function deactivate( string $plugin_name ) {
		...
		deactivate_plugin( $plugin_file_path, '', Constands::is_multisite() );
    }
